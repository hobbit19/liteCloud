...
if(strlen($directory) == 0) return "<goto class=\"nxt\" style=\"background:none;\" href=\"{$application['api']['urlapp']}&dir=/\">
...
$bc .= "<goto style=\"" . (($i == count($points) - 1) ? "background:none;" : "")
...
return "<goto class=\"nxt\" href=\"{$application['api']['urlapp']}&dir=/\">
