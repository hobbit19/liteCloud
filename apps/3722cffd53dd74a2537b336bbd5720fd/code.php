...
// Error in image's software, code dont work without "/" in url
...
}else
{
		...
		}else
		{
			...
			$APP['tmp']->set('pad', '
			<div id="devices"><div class="block"><a style="padding-left:0px;" href="'.$APP['url_app'].'&dir=/" id="right">Дом</a>'.$bh.'</div></div>');
