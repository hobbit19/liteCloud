...
function filewindow($fullpath = '', $filename = '', $appurl = '', $dir = '')
{
    ...
    <td class="right"><div>
    <input filter-input="true" style="width:363px;" placeholder="Имя файла" value="' . $filename . '" type="text" name="kkkk">
    <winquery>Переименовать</winquery></div><table id="tableinwin">
    <tr><td valign="top" class="left_text">Дата изменения</td>
    <td>' . $about['time'] . '</td></tr><tr><td valign="top" class="left_text">Вес файла</td>
    <td>' . $about['size'] . '</td></tr><tr><td valign="top" class="left_text">Права файла</td>
